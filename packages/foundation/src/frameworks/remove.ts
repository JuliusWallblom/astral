...
export const removeNextConfig = async (targetPath: string): Promise<void> => {
    ...
    if (configFile) {
        ...
        // Remove the Astral plugin configuration with any object
        ...
        console.log(`Astral plugin configuration removed from ${fullPath}`);
    } else {
...
export const removeViteConfig = async (targetPath: string): Promise<void> => {
    ...
    if (configFile) {
        ...
        // Remove the Astral babel plugin from the plugins array
        ...
        await fs.promises.writeFile(fullPath, content, 'utf8');
        console.log(`Astral babel plugin removed from ${fullPath}`);
    } else {
